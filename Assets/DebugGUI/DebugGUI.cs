...
public class DebugGUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (LogsEnabled)
        {
            ...
            while (transientLogs.Count > 0 && transientLogs.Peek().expiryTime <= UnityEngine.Time.realtimeSinceStartup)
            {
    ...
    struct TransientLog
    {
        ...
        {
            this.text = text;
            expiryTime = UnityEngine.Time.realtimeSinceStartup + duration;
        }
    }
